   ...
   //           System.err.println("cc<3");
            ...
            //minTable non complétés
                ...
                for (int[][] alligne : allignes) {
                    for (int[] pos : alligne) {
                        compt += minTables.get(i).getSquare(minTables.get(i).get)*3+pos[0],minTables.get(i).gety()*3+pos[1]).getPos();
                    }
                    if(compt==2) {
                ...
                re.clear();
                    ...
                    compt2=-1;
                        ...
                        if(possiblePlays.size()>0) {
                            //System.err.println("possiblePlays "+ " " + possiblePlays.get(0).get) + " " + possiblePlays.get(0).gety());
                        }
